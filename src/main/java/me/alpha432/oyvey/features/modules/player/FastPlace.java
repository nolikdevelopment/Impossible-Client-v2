...
public class FastPlace extends Module {
    ...
    public Setting<Boolean> blocks = bool("Blocks", true);
    public Setting<Boolean> ec = bool("EnderChests", true);
    ...
    public void onUpdate() {
        ...
        if (mc.player.isHolding(Items.ENDER_CHEST) && ec.getValue()) {
            mc.itemUseCooldown = 0;
        }
        if (mc.player.getMainHandStack().getItem() instanceof BlockItem && blocks.getValue()) {
            mc.itemUseCooldown = 0;
        }
    }
}
